...
def getProgramStatus():
    ...
    try:
        data = json.loads(ospiProgramStatus.data)
    except:
...
def getStationStatus():
    ...
    try:
        data = json.loads(ospiStationStatus.data)
    except:
...
def getStationName(id):
    try:
        url="http://localhost:" + ospiPort + "/jn?pw=" + ospiApiPasswordHash
        ospiStationName = http.request("GET", url)
    ...
    try:
        data = json.loads(ospiStationName.data)
    except:
...
def getRainSensorStatus():
    ...
    try:
        ...
        ospiRainSensorEnabled = http.request("GET", url)
        enabled = json.loads(ospiRainSensorEnabled.data)
    except:
    ...
    if (enabled["urs"] == 1):
        ...
        try:
            url="http://localhost:" + ospiPort + "/jc?pw=" + ospiApiPasswordHash
            ospiRainSensorStatus = http.request("GET", url)
        ...
        try:
            data = json.loads(ospiRainSensorStatus.data)
        except:
...
def getWaterLevel():
    ...
    try:
        data = json.loads(ospiWaterLevel.data)
    except:
